...
class MenCarousel extends StatefulWidget {
  const MenCarousel({Key? key}) : super(key: key);

  @override
  _MenCarouselState createState() => _MenCarouselState();
}

class _MenCarouselState extends State<MenCarousel> {
  int activeIndex = 0;
  var document = FirebaseFirestore.instance.collection("Mens").doc('Sliders');
